...
struct TranspilerStressTest : public ::testing::Test {
    ...
    const lc_expr* transpile_with(lc_transpiler_manifest& bundle, const aml_expr* e,
    ...
    const lc_expr* transpile_with_builtins(lc_transpiler_manifest& bundle, const aml_expr* e) {
