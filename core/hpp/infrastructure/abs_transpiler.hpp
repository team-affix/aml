...
template<typename ITranspileExpr, typename IMakeLcAbs>
...
abs_transpiler<IT, IL>::abs_transpiler(IT& transpile_expr, IL& make_abs)
...
const lc_expr* abs_transpiler<IT, IL>::transpile_abs(const aml_expr::abs& a,
    ...
    inner.push(a.param);
    return make_abs_.make_abs(transpile_expr_.transpile(a.body, inner, global));
}
