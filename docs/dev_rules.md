...
prefer DI via references: structs should not own large collaborators with behavior (e.g. integer_transpiler holds a reference to scott_nat_transpiler supplied at construction). Value objects and small state are fine to own.
